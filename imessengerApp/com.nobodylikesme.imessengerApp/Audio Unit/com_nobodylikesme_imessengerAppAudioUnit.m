//
//  com_nobodylikesme_imessengerAppAudioUnit.m
//  com.nobodylikesme.imessengerApp
//
//  Created by a-robota on 5/17/22.
//

#import "com_nobodylikesme_imessengerAppAudioUnit.h"
...
@interface com_nobodylikesme_imessengerAppAudioUnit ()
...
@implementation com_nobodylikesme_imessengerAppAudioUnit
...
- (instancetype)initWithComponentDescription:(AudioComponentDescription)componentDescription options:(AudioComponentInstantiationOptions)options error:(NSError **)outError {
	...
	_kernelAdapter = [[com_nobodylikesme_imessengerAppDSPKernelAdapter alloc] init];
...
- (void)setupParameterCallbacks {
	...
	__block com_nobodylikesme_imessengerAppDSPKernelAdapter * kernelAdapter = _kernelAdapter;
