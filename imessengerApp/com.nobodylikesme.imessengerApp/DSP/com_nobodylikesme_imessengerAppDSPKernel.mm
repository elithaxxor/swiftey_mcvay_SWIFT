//
//  com_nobodylikesme_imessengerAppDSPKernel.mm
...
#import "com_nobodylikesme_imessengerAppDSPKernel.hpp"
#import "com_nobodylikesme_imessengerAppDSPKernelAdapter.h"

@implementation com_nobodylikesme_imessengerAppDSPKernelAdapter {
    // C++ members need to be ivars; they would be copied on access if they were properties.
    com_nobodylikesme_imessengerAppDSPKernel  _kernel;
...
- (AUInternalRenderBlock)internalRenderBlock {
    ...
    __block com_nobodylikesme_imessengerAppDSPKernel *state = &_kernel;
