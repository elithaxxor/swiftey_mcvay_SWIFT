//
//  com_nobodylikesme_imessengerAppDSPKernel.hpp
//  com.nobodylikesme.imessengerApp
//
//  Created by a-robota on 5/17/22.
//

#ifndef com_nobodylikesme_imessengerAppDSPKernel_hpp
#define com_nobodylikesme_imessengerAppDSPKernel_hpp
...
/*
 com_nobodylikesme_imessengerAppDSPKernel
 Performs simple copying of the input signal to the output.
 As a non-ObjC class, this is safe to use from render thread.
 */
class com_nobodylikesme_imessengerAppDSPKernel : public DSPKernel {
public:
...
#endif /* com_nobodylikesme_imessengerAppDSPKernel_hpp */
